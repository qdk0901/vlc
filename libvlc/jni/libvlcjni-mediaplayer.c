...
void
Java_org_videolan_libvlc_MediaPlayer_setChannelMute(JNIEnv *env, jobject thiz,
                                               jint channel, jint mute)
{
    vlcjni_object *p_obj = VLCJniObject_getInstance(env, thiz);
    ...
    libvlc_audio_set_channel_mute(p_obj->u.p_mp, (int) channel, (int) mute);
}

void
Java_org_videolan_libvlc_MediaPlayer_setMusicMode(JNIEnv *env, jobject thiz,
                                               jint mode)
{
    vlcjni_object *p_obj = VLCJniObject_getInstance(env, thiz);
    ...
    libvlc_audio_set_music_mode(p_obj->u.p_mp, (int) mode);
}
...
/* Returns 0 if the channel was set, -1 if it was out of range or error */
jint
