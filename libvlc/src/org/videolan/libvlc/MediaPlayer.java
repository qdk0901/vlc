...
public class MediaPlayer extends VLCObject<MediaPlayer.Event> {
	...
	public static final int MM_STEREO_TO_STEREO = 0;
	public static final int MM_LEFT_CHANNEL_TO_STEREO = 1;
	public static final int MM_RIGHT_CHANNEL_TO_STEREO = 2;
	...
	public native void setChannelMute(int channel, int mute);
        public native void setMusicMode(int mode);
