...
LIBVLC_API void libvlc_audio_set_channel_mute( libvlc_media_player_t *p_mi, int channel, int status );

LIBVLC_API void libvlc_audio_set_music_mode( libvlc_media_player_t *p_mi, int mode);
/**
